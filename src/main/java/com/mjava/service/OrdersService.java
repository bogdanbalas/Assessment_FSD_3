...
public class OrdersService {
	...
	private OrdersDao orderDao;
	 ...
	 public void insertBookingInfoService(int shoeid, String name, int categeory,
			 double price, int quantity, double totalprice, Date date, String purchasedby )
	 {
		 OrderedShoeModel  orderedShoeModel =new  OrderedShoeModel(shoeid, categeory, price, quantity, date, name, totalprice, purchasedby);
