 ...
 public ShoesDataModel  getshoesDataByIdService(int seletedShoeId)
{
 ...
 public boolean  insertNewProductService(int categeory,double price,String name)
 {
		boolean isInsertedNewProduct = false;
		try {
			
		
	 ShoesDataModel s=new ShoesDataModel(categeory,price, name);
 ...
 public  boolean  updateShoeProductService( int categeory,   double price,
		...
		boolean isUpdated=false;
		    count=  shoesDao.updateShoeProduct(categeory, price, name,  id);
